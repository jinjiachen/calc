...
class search_WN(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self,None,-1,'带颈对焊参数查询',size=(700,600))
        panel=wx.Panel(self)
        ...
        wx.StaticText(panel,-1,'法兰颈N(A):',(10,320))
        self.text9=wx.TextCtrl(panel,-1,'',(120,320),(80,20))
        wx.StaticText(panel,-1,'法兰颈N(B)',(10,350))
        self.text10=wx.TextCtrl(panel,-1,'',(120,350),(80,20))
        wx.StaticText(panel,-1,'法兰颈S:',(10,380))
        self.text11=wx.TextCtrl(panel,-1,'',(120,380),(80,20))
        wx.StaticText(panel,-1,'法兰颈H1:',(10,410))
        ...
        image=wx.Image('d:/repo/calc/images/WN.jpg',wx.BITMAP_TYPE_ANY)
